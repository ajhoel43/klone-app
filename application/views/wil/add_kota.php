<div class="modal-dialog modal-lg">
	<div class="modal-content">
		<div class="modal-header">
			...
			<h4 class="modal-title"><?php echo "New ".lang('label_kota') ?></h4>
		</div>
			...
			<form class="form-horizontal" name="form_add">
				<div class="form-group">
					...
					<div class="col-sm-6">
						...
						<div class="col-xs-5">
							<input type="text" class="form-control" name="kode_wil" placeholder="<?php echo lang('label_wil_kode') ?>" readonly>
						</div>
						<div class="col-xs-6">
							<input type="text" class="form-control" name="nama_wil" placeholder="<?php echo lang('label_wil') ?>" disabled>
						</div>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-6">
						<input type="number" class="form-control" name="kode_kota" value="<?php echo set_value('kode_kota') ?>">
					</div>
